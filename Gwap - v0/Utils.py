...
class Utils:
    ...
    def writeVoteData(self, user, img_id, list_imgs, game_session):
        ...
        f.write(str(game_session) + "," + user + "," + picname + "\n")

    
    def writeVoteAndTagsData(self, user, message, list_imgs, game_session):
